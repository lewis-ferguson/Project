...
I used figma to create a vector graphic to use as my logo in the main header of each web page.
...
![destination page wireframe ](/images/wireframe_destinations.png)
